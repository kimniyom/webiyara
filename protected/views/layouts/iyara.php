...
?>
            ...
            <!-- -->
            <header class="header-style-2 nav" id="header-navs" style="border-bottom: #cccccc solid 0px; padding: 10px;"><!-- /images/bgheader.png -->
                        ...
                        <div class="header-1-inner">
                            ...
                            <nav class="menuheadphoneguru">
                                <ul class="menu hidden-xs">
                                    ...
                                    <li>
                                        <a class="active" style="font-weight: normal;" href="<?php echo Yii::app()->createUrl('frontend/product') ?>" >Product </a>
                                        <!--
