    ...
    <body class="animsition animsition" style="background: #000000;">
        ...
        <div class="home-1" id="page">
            ...
            <nav id="menu" style="background:#ffffff; color:red;">
                ...
                <!-- -->
            <header class="header-style-2" id="header-nav" style="background:url('<?php echo Yii::app()->baseUrl; ?>/images/black-glass.png');border-bottom: #cccccc solid 0px; padding: 10px;"><!-- /images/bgheader.png-->
