...
<script type="text/javascript">
    load_answer();
    function Answer_msg() {
        var url = "<?php echo Yii::app()->createUrl('frontend/message/answer_msg') ?>";
    ...
    function load_answer() {
        var url = "<?php echo Yii::app()->createUrl('frontend/message/get_answer') ?>";
        var msg_id = "<?php echo $msg['id'] ?>";
        var data = {
            msg_id: msg_id
        };
...
$this->breadcrumbs = array(
    "กล่องข้อความ" => array('frontend/message'),
    $msg['id']
);
if (!empty($msg['images'])) {
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-xs-2 col-sm-2 col-md-1 col-lg-1">
                <img class="media-object img-responsive img-thumbnail" src="<?php echo Yii::app()->baseUrl; ?>/<?php echo $img ?>" style="max-width: 50px;">
            </div>
            <div class="col-xs-10 col-sm-10 col-md-11 col-lg-11">
                <i class="fa fa-trash-o pull-right btn" title="ลบ" 
                   onclick="delete_msg('<?php echo $msg['id'] ?>')"></i>
                <b><i class="fa fa-envelope-o"></i> <?php echo $msg['message'] ?></b><br/>
...
<script>
    ...
    function delete_msg(id) {
        ...
        var url = "<?php echo Yii::app()->createUrl('frontend/message/delete_msg') ?>";
        var data = {id: id};
        if (r == true) {
            $.post(url, data, function (success) {
                $("#flag_del").fadeIn();
                window.location = "<?php echo Yii::app()->createUrl('frontend/message') ?>";
            });
        }
    }
</script>
